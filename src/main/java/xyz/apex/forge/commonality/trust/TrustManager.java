...
public final class TrustManager
{
	...
	{
		throwIfUntrusted(modId, () -> new ModFileLoadingException("Mod '%s' downloaded from Untrustworthy location! Download from trusted sources to play with this mod.".formatted(modId)));
	}
